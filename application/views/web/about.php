<div id="content" class="about-page">
    <div class="page-content-wrap2">
        ...
        <?php
        if ($this->site_info->about_info) { ?>
            <div class="page-section type5 half-bg-col">
                <div class="img-col-left"><div class="col-bg" data-bg="<?php echo base_url('uploads/pix/info/'.$this->site_info->about_info_photo); ?>"></div></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="content-element3">
                                <?php echo $this->site_info->about_info; ?>
                            </div>
                        </div>
                    </div>
                </div>

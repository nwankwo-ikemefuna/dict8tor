...
function show_alert($msg, $bg = 'info', $class = '') {
    echo '<div class="alert alert-'.$bg.' '.$class.'" role="alert">'.$msg.'</div>';
}
...
function ajax_overlay_loader() { ?>
    <div id="ajax_overlay_loader">
        <div id="overlay_content">
            ...
            <button class="btn btn-secondary btn-sm m-t-20" id="delayed_close_btn" onclick="ajax_loading_hide();" style="display: none;">Save Me</button>
        </div>
    </div>
    <?php
}